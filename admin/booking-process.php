...
if(isset($_POST) & !empty($_POST)){
		...
		$id = filter_var($_POST['orderid'], FILTER_SANITIZE_NUMBER_INT);
			...
			if($ordprcres){
				$ordupd = "UPDATE rents SET orderstatus='$status' WHERE id=$id";
...
<div class="container">
			<div class="row">
				...
				<?php
					...
					$ordsql = "SELECT * FROM rents WHERE id='$oid'";
				...
				<?php } ?>
					...
					<input type="hidden" name="orderid" value="<?php echo $_GET['id']; ?>">		 
						<div class="space30"></div>
					<input type="submit" class="btn btn-dark btn-rounded" value="Update Order Status">
					</div>
				</div>
