<?php
	...
	if(isset($_POST) & !empty($_POST)){
		...
		$sql = "UPDATE products SET name='$prodname', prod_desc='$description', catid='$category', price='$price', 
		short_desc='$short_desc',thumb='$filepath' WHERE id = $id";
...
<div class="card">
  <div class="card-body">
  <h5 class="text-center text-dark">Edit a existing Product!</h5>
  </div>
</div>
		...
		<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
			    ...
			    <textarea class="form-control" name="productdescription" rows="3"><?php echo $r['prod_desc']; ?></textarea>
			  </div>

			  <div class="form-group">
			    <label for="short_desc">Product Description</label>
			    <textarea class="form-control" name="short_desc" rows="3"><?php echo $r['short_desc']; ?></textarea>
			  </div>
